...
function withRouter(WrappedComponent, options) {
  ...
  var enhancedWithRouter = (0, _ContextUtils.ContextSubscriberEnhancer)(WithRouter, 'router', { withRef: withRef });
  ...
  return (0, _hoistNonReactStatics2.default)(enhancedWithRouter, WrappedComponent);
}
